...
class Bundle extends BundleBase {
  ...
  {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};let sourceMapUrl = _ref.sourceMapUrl,dev = _ref.dev,minify = _ref.minify,ramGroups = _ref.ramGroups;
    super();
...

  {
    ...
    return resolver.wrapModule({
      ...
      minify: this._minify,
      dev: this._dev }).
    then((_ref2) => {let code = _ref2.code,map = _ref2.map;
      ...
      index, new ModuleTransport(_extends({}, moduleTransport, { code, map })));
    });
  }
...
function shouldPreload(_ref3) {let meta = _ref3.meta;
...
{let seen = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : new Set();
  ...
  for (const _ref4 of meta.dependencyPairs || []) {var _ref5 = _slicedToArray(_ref4, 2);const path = _ref5[1].path;
