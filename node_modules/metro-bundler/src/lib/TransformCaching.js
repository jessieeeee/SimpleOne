...
/**
   ...
   * a new one.
   */
function useProjectDir(projectPath) {
...
/**
   ...
   */
function useMetaDirPath(metaDirPath) {
...
/**
   ...
   */
function readMetaDirPath(metaFilePath) {
...
/**
   ...
   */
function createMetaDir(metaFilePath) {
